...
const TicCenatp = (props) => {
    const { canCreate, canUpdate, canDelete } = useCrudActionPermissions('tic_cenatp');
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <div className="flex flex-wrap gap-1">
                        ...
                        <div className="flex flex-wrap gap-1">
                            {(props.cenatpTip === 'CREATE' && canCreate) ? (
                                <Button
                            ...
                            {(props.cenatpTip !== 'CREATE' && canDelete) ? (
                                <Button
                            ...
                            {(props.cenatpTip !== 'CREATE' && canUpdate) ? (
                                <Button
