...
import { CoffDocsService } from "../../service/model/CoffDocsServiceOld";
...
export default function CoffDocsorderL(props) {

 console.log(props,"*******************CoffDocsorderL************************")
  ...
  emptyTicDocs.doc = props.coffDoc.id
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ++i
        if (i < 2) {
          const ticDocsService = new CoffDocsService();
