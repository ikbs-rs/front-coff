...
export default function CoffIzv01L(props) {
  ...
  const cols = [
    { field: 'nzap', header: 'Zap', width: '20%' },
    { field: 'vreme', header: 'Vreme', width: '10%' },
    { field: 'mesto', header: 'Mesto', width: '10%' },
    ...
    { field: 'cena', header: 'Cena', width: '10%' },
    { field: 'username', header: 'Korisnik', width: '10%' },
    { field: 'mtroska', header: 'M. troska', width: '10%' },
    { field: 'oblast', header: 'Oblast', width: '10%' },
    { field: 'pravilnik', header: 'Pravilnik', width: '10%' }
  ];
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const data = await coffIzvService.getIzv01();
        console.log("@@@@@@@@@@@@@", data)
        setCoffIzv01s(data);
        initFilters();
        // }
